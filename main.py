...
def get_script_and_prompts(channel_type, hook_theme):
    ...
    if channel_type == "GADGETS":
        ...
        2. NO MENTION OF SURAT OR SPECIFIC CODE LINES. Emphasize freedom from 9 to 5.
        ...
        2. NO MENTION OF SPECIFIC CITIES OR CODE LINES. Highlight the magic of the AI tool doing all the work.
        ...
        2. NO MENTION OF SPECIFIC CITIES OR CODE LINES. Challenge people who still edit manually.
...
def make_video(image_files, captions, final_vid, audio_file):
    ...
    video = concatenate_videoclips(clips, method="compose").set_audio(main_audio).subclip(0, audio_duration)
